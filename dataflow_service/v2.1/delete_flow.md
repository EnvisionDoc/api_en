...
```
GET https://{apigw-address}/batch-processing-service/v2.1/flows?action=delete
```
...
public void delFlowTest(){
        ...
        String secretKey = "yourAppAccessKey";
        ...
        try {
            JSONObject response = Poseidon.config(PConfig.init().appKey(accessKey).appSecret(secretKey).debug())
                    .url("https://{apigw-address}/batch-processing-service/v2.1/flows?action=delete")
