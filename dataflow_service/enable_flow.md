...
```
POST https://{apigw-address}/dataflow-batch-service/v2.0/flows?action=enable
```
...
```json
url: https://{apigw-address}/dataflow-batch-service/v2.0/flows?action=enable&userId=yourUserId&orgId=yourOrgId
method: POST
requestBody:
{
  "flowId": 3377
